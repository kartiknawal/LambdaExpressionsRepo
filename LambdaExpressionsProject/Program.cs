...
namespace LambdaExpressionsProject
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Retrieveing_TopTwoRecord_ForAgels_LessThanSixty(listPersonsInCity);
        ...
        private static void Retrieveing_TopTwoRecord_ForAgels_LessThanSixty(List<Person> listPersonsInCity)
        {
            foreach (Person person in listPersonsInCity(List<Person> listPersonsInCity))
            {
